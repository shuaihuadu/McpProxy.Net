...
public class HttpClientProvider : IHttpClientProvider
{
    ...
    /// 创建用于SSE连接的HTTP客户端
    /// </summary>
    /// <param name="config">SSE客户端配置</param>
    /// <returns>配置的HttpClient实例</returns>
    public HttpClient CreateSseClient(SseClientConfig config)
    {
        ...
        HttpClient httpClient = this.CreateAuthenticatedHttpClient("SSE_Client", httpConfig);
    ...
    /// <returns>配置的HttpClient实例</returns>
    public HttpClient CreateApiClient(AuthConfig? authConfig = null, int timeoutSeconds = 30)
    {
        ...
        return this.CreateAuthenticatedHttpClient("API_Client", config);
    }
    ...
    public HttpClient CreateSimpleClient(int timeoutSeconds = 30)
    {
        return this.CreateAuthenticatedHttpClient("SIMPLE_Client", new HttpClientConfig
        {
            TimeoutSeconds = timeoutSeconds
        });
    }
